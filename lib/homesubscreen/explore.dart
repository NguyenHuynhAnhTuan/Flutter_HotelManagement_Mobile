          ...
          SliverAppBar(
            ...
            title: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
              ...
              Padding(
                ...
                child: Text(
                   // _loggedInUser!.username!.length > 20 ? "${_loggedInUser!.username!.substring(0,19)}..." : _loggedInUser!.username.toString(),
                  _loggedInUser == null ? "Guest" : _loggedInUser!.username!.length > 20 ? "${_loggedInUser!.username!.substring(0,19)}..." : _loggedInUser!.username.toString(),
                  style: TextStyle(
                    fontSize: 20,
